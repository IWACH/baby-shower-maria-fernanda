      ...
      <DialogContent className="max-w-[calc(100%-2rem)] sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            Instrucciones para reservar regalos en el Depa Shower de Yae
          </DialogDescription>
        </DialogHeader>
        <div className="py-4 space-y-4 text-center text-muted-foreground leading-relaxed">
          <p>
            Al hacer clic en el botón{" "}
            <strong className="text-primary">Elegir para Yae 🎁</strong> solo
          ...
          <p>
            ...
            mucho cariño el día del Depa Shower de Yae 🎀💕.
          </p>
          <p className="font-medium text-foreground pt-2">
            ¡Gracias por tu cariño y por acompañarme en este momento tan
            especial! 💕🫶
          </p>
        </div>
